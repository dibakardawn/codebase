	...
	t.rcrop = {
		...
		var o = function() {
			...
			y = function() {
				...
				var i = u();
				a.preview = t('<canvas id="outputCanvas" width="' + i[0] + '" height="' + i[1] + '" style="margin-top:16px;"></canvas>'), a.preview.appendTo(e)
			},
			w = function(t) {
				var e = a.cropData;
				t && (e = z({
		...
		this.getValues = function() {
			...
			var r = t('<canvas id="outputCanvas" width="' + e + '" height="' + i + '" style="margin-top:16px;"></canvas>');
