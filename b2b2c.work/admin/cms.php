...
if($ACTION == "DELETE" && $cmsId > 0){
	$sql_delete = "DELETE FROM cms WHERE `cms`.`cmsId` = ".$cmsId;
		...
		<div class="w3-main">
			<div id="cmsSectionHolder">
				...
				<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 marBot5">
					<form id="cmsForm" name="cmsForm" method="POST" action="<?php echo $_SERVER['PHP_SELF']?>">
						<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 nopaddingOnly marBot5">
							<select id="section" name="section" class="pull-left h34 marRig10 marBot5" onchange="settingsFunctionality.onSectionDDLChange()">
							...
							<?php if($section != ""){ ?>
							<select id="page" name="page" class="pull-left h34 marRig10 marBot5" onchange="settingsFunctionality.onPageDDLChnage()">
							...
							<?php } ?>
							<button type="button" class="btn btn-success pull-right marBot5 marRig5" onClick="settingsFunctionality.gotoAddCms()">Add Content</button>
						</div>
					</form>
				</div>
				<div id="cmsTableHolder" class="col-lg-12 col-md-12 col-sm-12 col-xs-12 marBot5 scrollX">
				</div>
			</div>
			<br clear="all">
